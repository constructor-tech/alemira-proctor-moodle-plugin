...
/**
 * Event fired when a proctoring session is finished.
 *
 * @package    availability_proctor
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class session_finished extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_session_finished', 'availability_proctor');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' finished a proctoring session " .
