...
class preset_form extends \moodleform {
    protected function definition() {
        ...
        // ---- Exam mode ----
        if (brand::is_form_field_visible('preset_section_mode')) {
        ...
        // ---- Identity ----
        if (brand::is_form_field_visible('preset_section_identity')) {
        ...
        // ---- Secure Browser ----
        if (brand::is_form_field_visible('preset_section_securebrowser')) {
        ...
        if (brand::is_form_field_visible('warnings')) {
            ...
            foreach (condition::WARNINGS as $key => $default) {
                ...
                if (isset($warningtorule[$key]) && brand::is_form_field_visible('rules')) {
