...
/**
 * Bridge page for SCORM proctoring.
 *
 * Proctor's content frame lands here (via the redirect URL entry.php emits).
 * Unlike entry.php, this page runs in the real browser context with full cookies,
 * so we can safely set the session and then redirect to the actual SCORM view.
 *
